...
tuner = kt.Hyperband(build_model_convlstm, objective=kt.Objective("val_l_acc", direction="max"), max_epochs=200, hyperband_iterations=2)
...
tuner.search(D_TRAIN[0], D_TRAIN[1],
