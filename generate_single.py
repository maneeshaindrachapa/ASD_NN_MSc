...
if __name__ == '__main__':
    print('Loading Data')
    data = pd.read_feather('002-data-clean.ftr')
    print('OK')
    ...
    if CREATE_FULL_DATASET:
        ...
        dp = data.loc["004"].set_index('Epoch')
        ...
        dataset[f'{"004"}_x'] = p_data
        print(p_data.shape)
    print('OK')

    # save dataset
    print('Saving processed data')
    np.savez_compressed('002-data-processed.npz', **dataset)
    print('OK')
...
if CREATE_BANDS_DATASET:
    ...
    np.savez_compressed('002-data-processed-bands.npz', **band_dataset)
    print('OK')
